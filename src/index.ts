...
const ROUTES = {
  "POST /": {
    accepts: [
      { scheme: "exact", price: "$1.00", network: "eip155:8453", payTo: "0x0" as `0x${string}` },
      { scheme: "exact", price: "$1.00", network: "eip155:137", payTo: "0x0" as `0x${string}` },
      { scheme: "exact", price: "$1.00", network: "solana:5eykt4UsFv8P8NJdTREpY1vzqKqZKvdp", payTo: "CvraJ4avKPpJNLvMhMH5ip2ihdt85PXvDwfzXdziUxRq" },
    ],
...
app.use(stripeApiKeyMiddleware({ serviceName: "gpu" }));
